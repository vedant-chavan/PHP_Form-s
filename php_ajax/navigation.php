  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="login_ajax.php">Login</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="reg_ajax.php">Registration</a>
        </li>
        <li class="nav-item">
    ...
    if (isset($_SESSION['id']) && isset($_SESSION['email'])) { ?>
      ...
      <button type="button" class="btn btn-warning btn-sm  nav-item">
        <a class="nav-link text-primary" href="update_ajax.php?id=<?= $_SESSION['id'] ?>">UPDATE PROFILE</a>
      <?php
    }
      ?>
