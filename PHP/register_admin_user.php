      ...
      <table class="table table-bordered border-dark" style="width:50% " align="center">
        ...
        ?>
          <tr style="height:100%" class="table-info">
            ...
            <td>
              <button type="button" class="btn btn-outline-dark btn-sm"><a href="update_form.php?id=<?= $row['id'] ?>" class="text-success">Update</a></button>

              <button type="button" class="btn btn-danger btn-sm"><a href="delete.php?id=<?= $row['id'] ?>" class="text-warning">X</a></button>
            </td>
          </tr>
        <?php
          $i++;
